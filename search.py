...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("El número de nodos visitados es:" + str(count))
            return node
...
def branch_Bound(problem):
    return graph_search(problem,branch_Bound_g())

def branch_Bound_priority(problem):
    return graph_search(problem,branch_Bound_estimate(problem))
